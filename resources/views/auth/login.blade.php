    ...
    <div class="max-w-md w-full space-y-8">
        ...
        <div class="text-center">
            ...
            <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                Nu ai cont încă?
                <a href="{{ route('register') }}" class="font-medium text-[#C81424] hover:text-[#94111B] transition">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        <input id="remember_me" name="remember" type="checkbox"
                            class="h-4 w-4 text-[#C81424] focus:ring-[#C81424] border-gray-300 dark:border-[#404040] rounded dark:bg-[#2C2C2C] cursor-pointer">
                    ...
                    @if (Route::has('password.request'))
                        <div class="text-sm">
                            <a href="{{ route('password.request') }}" class="font-medium text-[#C81424] hover:text-[#94111B] transition">
                                Ai uitat parola?
                            </a>
                        </div>
                    @endif
