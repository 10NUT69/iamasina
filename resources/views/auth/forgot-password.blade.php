        ...
        <div class="bg-white dark:bg-[#1E1E1E] py-8 px-6 shadow-xl rounded-2xl border border-gray-200 dark:border-[#333333] transition-colors">
            ...
            <form method="POST" action="{{ route('password.email') }}" class="space-y-6">
                ...
                <div class="text-center mt-4">
                    <a href="{{ route('login') }}" class="text-sm font-medium text-gray-600 dark:text-gray-400 hover:text-[#C81424] dark:hover:text-[#C81424] transition flex items-center justify-center gap-1">
