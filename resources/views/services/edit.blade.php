                    ...
                    <div class="space-y-4">
                        ...
                        <div class="relative">
                            ...
                            <input id="locality-search" type="text" autocomplete="off"
                                   value="{{ old('locality_name', $service->locality->name ?? '') }}"
                            ...
                            <input type="hidden" name="locality_id" id="locality-id" value="{{ old('locality_id', $savedLocalityId) }}">
                            <input type="hidden" name="county_id" id="county-id" value="{{ old('county_id', $savedCountyId) }}">
