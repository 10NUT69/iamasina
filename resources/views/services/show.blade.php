    ...
    <div class="w-full grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div class="lg:col-span-8 space-y-6">
            ...
            <div class="flex flex-wrap gap-2">
                <button type="button" onclick="shareServiceOnFacebook()" class="flex-1 md:flex-none inline-flex items-center justify-center gap-2 px-4 py-2.5 bg-[#1877F2] hover:bg-[#166fe5] text-white rounded-lg text-sm font-bold transition shadow-sm hover:shadow-md">
...
<script>
    ...
    function buildFacebookServiceShareUrl(display = 'popup') {
        const quoteMessage = serviceShareTitle
            ? `Uite acest anunț: ${serviceShareTitle}. Ce părere ai?`
            : 'Uite acest anunț.';
    ...
    function shareServiceOnFacebook() {
        const isMobile = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent || '')
            || ((navigator.platform || '') === 'MacIntel' && navigator.maxTouchPoints > 1);

        window.open(buildFacebookServiceShareUrl(isMobile ? 'touch' : 'popup'), '_blank', 'noopener');
    }
